...
@section('panelName')
    Dotação para Vale-Alimentação
@endsection

@section('content')
    <div class="ui loading teal segment" id="chart1-wrapper">
        <div id="chart1" style="width: 100%; height: 400px"></div>
    </div>

    <div class="ui loading blue segment" id="chart2-wrapper">
...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.indicadores.dotacao.vale', ['periodo' => $periodo]) }}', function(
            response) {
            ...
            let option1 = {
                title: {
                    text: 'Dotação para Vale-Alimentação',
