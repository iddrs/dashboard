...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.despesas.total', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                ...
                series: [{
                    ...
                    },
                    {
                        ...
                        data: response.data.map(item => item.receita_total_acum)
                    },
                    {
                        name: 'Empenhado',
                        type: 'line',
            ...
            let option2 = {
                ...
                series: [{
                    ...
                    },
                    {
                        ...
                        type: 'bar',
                        color: colorPalette.green,
                        data: response.data.map(item => item.receita_total_mes)
                    },
                    {
                        name: 'Empenhado',
                        type: 'bar',
