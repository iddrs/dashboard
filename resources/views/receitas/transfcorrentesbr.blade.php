...
@section('panelName')
    Transferencias Correntes da União
@endsection
...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.receitas.transfcorrentesbr', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                title: {
                    text: 'Transferências Correntes da União',
