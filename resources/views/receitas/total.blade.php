...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.receitas.total', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                ...
                series: [{
                    ...
                    //         return (item.dif_acum_arrec_ant_perc * 100).toFixed(2);
                    //     })
                    // },
                    // {
                    //     name: '% Previsto / Arrecadado',
                    //     type: 'bar',
                    //     yAxisIndex: 1,
                    //     color: ()
                    //     label: {
                    ...
                    //     },
                    //     data: response.data.map(item => {
                    //         return (item.dif_acum_arrec_prev_perc * 100).toFixed(2);
                    //     })
                    // }
                ]
            };
