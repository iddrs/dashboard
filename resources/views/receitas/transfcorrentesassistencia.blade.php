...
@section('panelName')
    Transferencias Correntes da Assistência Social
@endsection
...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.receitas.transfcorrentesassistencia', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                title: {
                    text: 'Transferências Correntes da Assistencia Social',
...
<script type="module">
    loadData('{{ route('resources.receitas.transfcorrentesassistencia', ['periodo' => $periodo]) }}', function(response) {
        console.log(response);
