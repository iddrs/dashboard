...
@section('panelName')
    Transferencias Correntes da Educação
@endsection
...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.receitas.transfcorrenteseducacao', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                title: {
                    text: 'Transferências Correntes da Educação',
