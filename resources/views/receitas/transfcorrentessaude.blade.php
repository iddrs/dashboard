...
@section('panelName')
    Transferencias Correntes da Saúde
@endsection
...
@push('scripts')
    <script type="module">
        loadData('{{ route('resources.collection.receitas.transfcorrentessaude', ['periodo' => $periodo]) }}', function(response) {
            ...
            let option1 = {
                title: {
                    text: 'Transferências Correntes da Saúde',
